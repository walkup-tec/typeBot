...
export const MASTER_LIBRARY_LOGIC_VERSION = "handoff-redirect-get-force-v48";

/** Altere a cada release que precise validar redeploy no Easypanel (serviço `api`). */
export const API_DEPLOY_MARKER = "DEPLOY-2026-06-05-handoff-redirect-get-force-v11";

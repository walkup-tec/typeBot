...
export const MASTER_LIBRARY_LOGIC_VERSION = "walkup-live-only-v5-published-typebot-id";

/** Altere a cada release que precise validar redeploy no Easypanel (serviço `api`). */
export const API_DEPLOY_MARKER = "DEPLOY-2026-06-03-api-biblioteca-v5-sync-fix";
